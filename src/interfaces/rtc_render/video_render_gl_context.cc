...
#else
//Ubuntu系统中, 使用了glew以打开shader功能，适用XDisplay
#include <GL/glew.h>
#include <GL/glut.h>
#include <X11/Xlib.h>
#include <GL/glx.h>
...
bool CGLContextObj::Init(int version)
{
    int fbcount;
